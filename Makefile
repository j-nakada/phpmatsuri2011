srcdir = /usr/local/src/php-5.3.8/ext/test_ext
builddir = /usr/local/src/php-5.3.8/ext/test_ext
top_srcdir = /usr/local/src/php-5.3.8/ext/test_ext
top_builddir = /usr/local/src/php-5.3.8/ext/test_ext
EGREP = /bin/grep -E
SED = /bin/sed
...
RE2C = exit 0;
AWK = gawk
shared_objects_test_ext = test_ext.lo
PHP_PECL_EXTENSION = test_ext
PHP_MODULES = $(phplibdir)/test_ext.la
PHP_ZEND_EX =
...
prefix = /usr/local
phplibdir = /usr/local/src/php-5.3.8/ext/test_ext/modules
